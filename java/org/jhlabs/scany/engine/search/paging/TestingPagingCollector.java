...
import org.jhlabs.scany.engine.search.paging.IterablePaging.ProgressRef;
import org.jhlabs.scany.engine.search.paging.IterablePaging.TotalHitsRef;
...
public class TestingPagingCollector {
	...
	public static void main(String[] args) throws Exception {
		...
		TermQuery query = new TermQuery(new Term("category", "cate01"));
		IterablePaging paging = new IterablePaging(service.getSearchModel("relation01"), query, 100);
		
		for (Record record : paging.skipTo(90).
							gather(20).
